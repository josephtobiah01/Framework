...
{
    public class UMIDDataService : IUMIDDataService
    {
        public async Task<UMIDResponse> PostOCRLiteAsync(Stream ocrImage, string cardType)
        {
            ...
            var data = JsonConvert.DeserializeObject<UMIDResponse>(JSONData);
