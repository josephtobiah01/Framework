...
{
    public class TinDataService : ITinDataService
    {
        public async Task<TinResponse> PostOCRLiteAsync(Stream ocrImage, string cardType)
        {
            ...
            var data = JsonConvert.DeserializeObject<TinResponse>(JSONData);
