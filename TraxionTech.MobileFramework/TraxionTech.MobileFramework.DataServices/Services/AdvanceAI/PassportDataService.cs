...
{
    public class PassportDataService : IPassportDataService
    {
        public async Task<PassportResponse> PostOCRLiteAsync(Stream ocrImage, string cardType)
        {
            ...
            var data = JsonConvert.DeserializeObject<PassportResponse>(JSONData);
